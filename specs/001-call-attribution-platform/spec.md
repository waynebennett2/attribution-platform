...
- **Alert**: One operational condition that has crossed its configured threshold — ingestion lag, publication failure rate, allocation failure rate or pool utilisation — with its threshold, when it was raised, its notification attempts, its acknowledgement and who made it, and when it cleared.
